...
- Fire, Ice, Electric, Digital, and Fear currently use code-drawn fallback ball art. Gravity uses `Gravity-Logo.png` for select but code-drawn fallback ball art in battle.
...
- `ToxicLuck-Win.mp3` exists but is intentionally unused until that fighter/feature is added.
